	...
	return (
		<div>
            ...
            <input type="checkbox"
              ...
              onChange={(e) => dispatch({ type: 'STATUS', payload: e.target.checked ? 'completed' : 'pending' })}
            />
					</div>
      ...
      {data.length===0?<div data-testid="no-project-container">No Project Found</div>
