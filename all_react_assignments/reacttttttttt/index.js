...
home.post('/marvel/addnew', (req, res) => {
...
home.get('/winningTeam', (req, res) => {
  ...
  home.patch("/marvel/update/:id", (req, res) => {
  ...
  home.patch("/dc/update/:id", (req, res) => {
    const data = JSON.parse(fs.readFileSync("./db.json", "utf-8"));
    const { id } = req.params;
  ...
  home.delete("/marvel/delete/:id",(req,res)=>{
    const {id}=req.params
    const data=JSON.parse(fs.readFileSync("./db.json","utf-8"))
...
home.delete("/dc/delete/:id",(req,res)=>{
    const {id}=req.params
    const data=JSON.parse(fs.readFileSync("./db.json","utf-8"))
